  ...
  return (
    <>
      ...
      <form onSubmit={enviar} className="mt-7 grid gap-4 sm:grid-cols-2">
        <CampoFormulario etiqueta="Nombres" name="first_name" value={formulario.first_name} onChange={actualizar} required />
        <CampoFormulario etiqueta="Apellidos" name="last_name" value={formulario.last_name} onChange={actualizar} required />
        <CampoFormulario className="sm:col-span-2" etiqueta="Correo electrónico" name="email" type="email" value={formulario.email} onChange={actualizar} required />
        <CampoFormulario className="sm:col-span-2" etiqueta="Contraseña" name="password" type="password" value={formulario.password} onChange={actualizar} minLength={8} required />
      ...
      <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-300">
        ¿Ya tienes cuenta?{" "}
        <Link to="/iniciar-sesion" className="font-bold text-bosque-600 dark:text-teal-300">
          Inicia sesión
        </Link>
      </p>
    </>
